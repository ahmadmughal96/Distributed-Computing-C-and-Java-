//Header files and Pre Processor directories
#include "mpi.h"
#include<iostream>
#include<vector>
#include <stdlib.h>
...
//	int array[nprocs];
	//initialize all the processes with -1
	...
	//initializer starts messaging and sends a message to process of higher rank
